...
currentVersion=`cat /usr/bin/backupmypi/version` #This version variable should not have a v but should contain all other characters ex Github release tag is v1.2.4 currentVersion is 1.2.4
repositoryName="backupmypi" #Name of repostiory to be updated
githubUserName="ItzMxrcxl" #username that hosts the repostiory
